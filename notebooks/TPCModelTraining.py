...
with open(global_config_path, 'r') as file:
    global_config_loaded_directly = yaml.safe_load(file)
...
ttr_model_name = "prod_dsexp_mlstore.third_party_capture.time_to_repair_lgbm"
ttr_model_uri  = f"models:/{ttr_model_name}@champion"

tpc_model_name = "prod_dsexp_mlstore.third_party_capture.third_party_capture_lgbm" 
...
# Define the final list of feature names after OHE and scaling
...
with mlflow.start_run(run_name="third_party_capture_with_benefit_logic") as run:
    ...
    monotonicity_dict = {
        ...
        "num__capturecuccess_adrienneversion": -1 
    }
    ...
    quantile_benefit_pd_df = pd.concat([quantile_benefit_pd_df, capture_benefit_bounds], axis=1)
