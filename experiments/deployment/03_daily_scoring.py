...
other_cols = ['claim_number', 'reported_date', 'start_date',  'num_failed_checks',
              'total_loss_flag', 'checks_list', 'delay_in_reporting', 'claim_id', 'position_status', 'vehicle_use_quote', 'Circumstances'] \
...
raw_df['flagged_by_model'] = np.where(raw_df['y_cmb']==1, 1, 0) #do this first after getting y_cmb
